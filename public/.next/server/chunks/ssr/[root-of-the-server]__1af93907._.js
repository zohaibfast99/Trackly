...
"[project]/app/data/project/get-workspace-projects.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const getWorkspaceProjectsByWorkspaceId = async (workspaceId)=>{
    try {
        const { user } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$user$2f$is$2d$user$2d$authenticated$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["userRequired"])();
        ...
        const query = isUserMember.accessLevel === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["AccessLevel"].OWNER ? {
            workspaceId
        } : {
            projectAccess: {
                some: {
        ...
        const [projects, workspaceMembers] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].project.findMany({
                where: query,
                select: {
                    name: true,
                    id: true,
...
"[project]/app/data/user/get-user.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getUserById = async ()=>{
    try {
        const { user } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$user$2f$is$2d$user$2d$authenticated$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["userRequired"])();
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                id: user.id
            }
        });
...
"[project]/components/sidebar/app-sidebar-container.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$user$2f$get$2d$user$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/data/user/get-user.ts [app-rsc] (ecmascript)");
...
;
;
const AppSidebarContainer = async ({ data, workspaceId })=>{
    const { projects, workspaceMembers } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$project$2f$get$2d$workspace$2d$projects$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWorkspaceProjectsByWorkspaceId"])(workspaceId);
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$user$2f$get$2d$user$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUserById"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sidebar$2f$app$2d$sidebar$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AppSidebar"], {
        ...
        fileName: "[project]/components/sidebar/app-sidebar-container.tsx",
        lineNumber: 33,
        columnNumber: 12
...
;
;
const buttonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95", {
    variants: {
        variant: {
            ...
            gradient: "gradient-primary text-white hover:opacity-90 shadow-medium hover:shadow-large"
        },
        size: {
...
const Button = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["forwardRef"](({ className, variant, size, asChild = false, loading, children, disabled, ...props }, ref)=>{
    const Comp = asChild ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$slot$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Slot"] : "button";
    // When using asChild, we can't add loading spinner as it violates Slot's single child rule
    if (asChild) {
...
"[project]/components/profile-avatar.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ProfileAvatar = ({ url, name, size = "md", className, numOfChars = 1 })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$avatar$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Avatar"], {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cn"])("h-8 w-8 rounded-md", size === "sm" && "h-6 w-6", size === "md" && "h-8 w-8", size === "lg" && "h-10 w-10", className),
        children: [
...
;
;
const badgeVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium smooth-transition focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
    variants: {
        variant: {
            default: "border-transparent bg-primary text-primary-foreground hover:bg-primary/80 shadow-soft",
            secondary: "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",
            destructive: "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 shadow-soft",
            outline: "text-foreground border-border hover:bg-accent",
            success: "border-transparent bg-green-600 text-white hover:bg-green-700 shadow-soft",
            warning: "border-transparent bg-yellow-600 text-white hover:bg-yellow-700 shadow-soft",
            info: "border-transparent bg-blue-600 text-white hover:bg-blue-700 shadow-soft",
            // Role variants
            OWNER: "bg-gradient-to-r from-pink-500 to-pink-600 text-white shadow-soft hover:from-pink-600 hover:to-pink-700",
            MEMBER: "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-soft hover:from-blue-600 hover:to-blue-700",
            VIWER: "bg-gradient-to-r from-gray-500 to-gray-600 text-white shadow-soft hover:from-gray-600 hover:to-gray-700",
            // Status variants
            TODO: "bg-gradient-to-r from-slate-500 to-slate-600 text-white shadow-soft hover:from-slate-600 hover:to-slate-700",
            IN_PROGRESS: "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-soft hover:from-blue-600 hover:to-blue-700",
            BACKLOG: "bg-gradient-to-r from-gray-400 to-gray-500 text-white shadow-soft hover:from-gray-500 hover:to-gray-600",
            IN_REVIEW: "bg-gradient-to-r from-purple-500 to-purple-600 text-white shadow-soft hover:from-purple-600 hover:to-purple-700",
            COMPLETED: "bg-gradient-to-r from-green-500 to-green-600 text-white shadow-soft hover:from-green-600 hover:to-green-700",
            BLOCKED: "bg-gradient-to-r from-red-500 to-red-600 text-white shadow-soft hover:from-red-600 hover:to-red-700",
            // Priority variants
            CRITICAL: "bg-gradient-to-r from-red-600 to-red-700 text-white shadow-soft hover:from-red-700 hover:to-red-800 animate-pulse",
            HIGH: "bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-soft hover:from-orange-600 hover:to-orange-700",
            MEDIUM: "bg-gradient-to-r from-yellow-500 to-yellow-600 text-white shadow-soft hover:from-yellow-600 hover:to-yellow-700",
            LOW: "bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-soft hover:from-emerald-600 hover:to-emerald-700"
        }
    },
    defaultVariants: {
        variant: "default"
...
;
;
const Navbar = ({ id, name, email, image })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "w-full flex items-center justify-between p-6 bg-card/50 backdrop-blur-sm border-b border-border/50",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: "Manage all your tasks in one place"
                    }, void 0, false, {
                        fileName: "[project]/components/navbar.tsx",
                        lineNumber: 25,
                        columnNumber: 17
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PopoverTrigger"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Button"], {
                                    variant: "ghost",
                                    className: "relative p-1 hover:bg-accent/50",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PopoverContent"], {
                                className: "w-64 p-4 shadow-large",
                                align: "end",
...
"[project]/components/loading/navigation-loading.tsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/loading/navigation-loading.tsx'\n\nExpected unicode escape");
e.code = 'MODULE_UNPARSABLE';
throw e;
}),
"[project]/app/(protected)/workspace/[workspaceId]/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sidebar$2f$app$2d$sidebar$2d$container$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/sidebar/app-sidebar-container.tsx [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$loading$2f$navigation$2d$loading$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/loading/navigation-loading.tsx [app-rsc] (ecmascript)");
;
;
;
;
...
;
;
const WorkspaceIdLayout = async ({ children, params })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sidebar$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SidebarProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$loading$2f$navigation$2d$loading$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["NavigationLoader"], {}, void 0, false, {
                fileName: "[project]/app/(protected)/workspace/[workspaceId]/layout.tsx",
                lineNumber: 29,
                columnNumber: 7
            }, ("TURBOPACK compile-time value", void 0)),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full flex bg-background h-screen",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sidebar$2f$app$2d$sidebar$2d$container$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["AppSidebarContainer"], {
                        data: data,
...
const __TURBOPACK__default__export__ = WorkspaceIdLayout;
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1af93907._.js.map