...
"[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/frontend/AuthProvider.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const m = {
    ...
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"].initialState
        ...
        try {
            ...
            const { accessToken: i, accessTokenEncoded: c, featureFlags: Y, idToken: v, organization: T, permissions: f, user: z, userOrganizations: E } = n, Z = ()=>i, V = ()=>c, ee = ()=>c, te = ()=>c, se = ()=>v, ne = ()=>g, oe = ()=>f, re = ()=>T, ae = ()=>z, ie = ()=>E, ce = (e, s = "access_token")=>{
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"].isDebugMode && console.error(t);
                }
            }, le = (e, s)=>{
                try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"].isDebugMode && console.error(n), u((i)=>({
                    ...i,
                    isLoading: !1,
                    error: n
                }));
...
"[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/frontend/hooks/use-sync-state.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/frontend/KindeBrowserClient.es.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$AuthProvider$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/frontend/AuthProvider.es.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/config/index.es.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$hooks$2f$use$2d$sync$2d$state$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/frontend/hooks/use-sync-state.es.js [app-ssr] (ecmascript)");
...
const F = async ()=>{
    try {
        const { refreshTokensServerAction: a } = await __turbopack_context__.A("[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/src/session/refreshTokensServerAction.es.js [app-ssr] (ecmascript, async loader)");
        return a;
    } catch  {
        return null;
    }
}, C = (a = process.env.NEXT_PUBLIC_KINDE_AUTH_API_PATH || process.env.KINDE_AUTH_API_PATH || "/api/auth")=>{
    const [r, i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$hooks$2f$use$2d$sync$2d$state$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncState"])({
        accessToken: null,
    ...
    const f = async ()=>{
        ...
        const n = `${a}/${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["routes"].setup}`, s = await fetch(n), { message: e, error: o, ...t } = await s.json();
        if (!s.ok) {
            i({
                ...r(),
                isLoading: !1,
        ...
        if (e && t.t && e !== t.t) throw Error(`Flag ${n} is of type ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$AuthProvider$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flagDataTypeMap"][t.t]} - requested type ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$AuthProvider$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flagDataTypeMap"][e]}`);
        return {
            code: n,
            type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$frontend$2f$AuthProvider$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flagDataTypeMap"][t.t || e],
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2d$oss$2f$kinde$2d$auth$2d$nextjs$2f$dist$2f$src$2f$config$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["config"].isDebugMode && console.error(e);
        }
    }, T = (n, s)=>{
        try {
...
//# sourceMappingURL=node_modules_070e5276._.js.map