    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchWorkspaceData = async ()=>{
            ...
            try {
                setLoading(true);
                setError(null);
                // Fetch workspace info, stats, and recent tasks in parallel
                const [workspaceRes, statsRes, tasksRes] = await Promise.all([
                    fetch(`/api/workspaces/${workspaceId}`),
                    fetch(`/api/workspaces/${workspaceId}/analytics`),
                    fetch(`/api/workspaces/${workspaceId}/tasks?limit=5&sortBy=updatedAt&sortOrder=desc`)
                ]);
                if (!workspaceRes.ok || !statsRes.ok || !tasksRes.ok) {
                    throw new Error('Failed to fetch workspace data');
                }
                const [workspaceData, statsData, tasksData] = await Promise.all([
                    workspaceRes.json(),
                    statsRes.json(),
                    tasksRes.json()
                ]);
...
//# sourceMappingURL=_59c36ad0._.js.map